...
![Version](https://img.shields.io/badge/version-2.4.7--beta.3-orange)
...
| **Z.AI** (Coding Plan)           | API Key¹ + ZCode    | ✅ Tested            | Independent quota windows and expiring 5-hour/weekly reset cards |
